...
exports.floorChoice = floorChoice;
exports.default = displayTitleScreen;
...
function floorChoice() {
    ...
    var answerFloor = readline.question('Choose the number of floors () : tap 1-2-3-4 : ');
...
function difficultyChoice() {
    ...
    var difficultyQuestion = readline.question('Choose your difficulty level between 1, 2 or 3');
...
function displayTitleScreen() {
    ...
    var question = readline.question('Please tap 1 or 2 :');
    var diff = '';
    switch (question) {
        case '1':
